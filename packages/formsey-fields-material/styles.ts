...
export const FORM_STYLES = css`
  ...
  formsey-multiple-choice-material, formsey-checkboxes-material, formsey-checkbox-material {
    display: flex;
    flex-direction: column;
  }

  formsey-multiple-choice-material .other, formsey-checkboxes-material .other {
    display: grid;
